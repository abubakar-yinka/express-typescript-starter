...
describe('paginate plugin', () => {
  ...
  describe('selectedFieldsToIncludeOrHide option', () => {
    const projects: IProject[] = [
      { name: 'Project One', milestones: 1 },
      { name: 'Project Two', milestones: 2 },
      { name: 'Project Three', milestones: 3 },
    ...
    test('should exclude a field when the hide param is specified', async () => {
      const projectPages = await Project.paginate({}, { selectedFieldsToIncludeOrHide: 'milestones:hide' });
    ...
    test('should exclude multiple fields when the hide param is specified', async () => {
      const projectPages = await Project.paginate({}, { selectedFieldsToIncludeOrHide: 'milestones:hide,name:hide' });
    ...
    test('should include a field when the include param is specified', async () => {
      const projectPages = await Project.paginate({}, { selectedFieldsToIncludeOrHide: 'milestones:include' });
    ...
    test('should include multiple fields when the include param is specified', async () => {
      const projectPages = await Project.paginate({}, { selectedFieldsToIncludeOrHide: 'milestones:include,name:include' });
